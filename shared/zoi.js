...
(function () {
  ...
  const S = {
    es: {
      ...
      products_eyebrow: '05 · productos',
      products_title: 'Cosas que ya uso yo mismo',
      products_sub: 'Apps propias, construidas con el mismo criterio: ni una línea de más.',
      prod_badge_live: 'live',
      prod_badge_soon: 'soon',
      prod_eva_d: 'Sincroniza el portal escolar de tus hijos y avisa al instante de notas, tareas y comunicados. En producción, usándola yo mismo cada día.',
      prod_eva_cta: 'eva.zoidev.com →',
      prod_nomilist_d: 'Todas tus finanzas unificadas en la palma de tu mano. Próximamente.',
    ...
    en: {
      ...
      products_eyebrow: '05 · products',
      products_title: 'Things I already use myself',
      products_sub: 'Own apps, built with the same rule: not a line more than needed.',
      prod_badge_live: 'live',
      prod_badge_soon: 'soon',
      prod_eva_d: 'Syncs your kids’ school portal and pings you the moment there’s a new grade, task or notice. In production, I use it myself every day.',
      prod_eva_cta: 'eva.zoidev.com →',
      prod_nomilist_d: 'All your finances, unified in the palm of your hand. Coming soon.',
